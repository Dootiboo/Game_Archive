...
<body>
    ...
    <section id='bg1'>
        <ul>
            ...
            <li><a href="uncategorised.php">Misc</a></li>
        </ul>
        <aside>
        ...
        <menu>
            ...
            <section id='form_input' style="display: none;">
                <form method="post" action="character_input.php">
                    <label for="name">
                        Name: <input type="text" name="name" id="name" max="25" />
                    </label>
                    <br />
                    <label for="surname">
                        Surname: <input type="text" name="surname" id="surname" max="50" />
                    </label>
                    <br />
                    <label for="age">
                    ...
                    <label for="gender">
                        ...
                        <br />
                        Nb <input type="radio" name="gender" id="nb" value="nb" />
                        <br />
                    </label>
                    <label for="pronouns">
                        Pronouns:
                    ...
                    <label for="race">
                        Race:
                        <br />
                        Human <input type="radio" name="race" id="human" value="human"><br />
                        Robot <input type="radio" name="race" id="robot" value="robot">
                    </label>
                    <br />
                    </label>
                    <label for="category">
                    ...
                    <br />
                    <label for="status">
                        Dead <input type="radio" value="dead" name="status">
                        Alive <input type="radio" value="alive" name="status">
                    </label>
                    <br />
